...
const AboutUs = () => {
    return (
        <div className='relative w-[547.92px] h-[600.11px]'>
            {/* outLine Border Div */}
            <div className='text-[50rem] text-red-500 absolute w-full h-full top-8 left-56 z-20 border-4 border-[#A8513A]'></div>
            {/* /outLine Border Div */}

            <div class="relative w-[547.92px] h-[600.11px] left-72 overflow-hidden z-0">
                {/* main BG Img */}
